    ...
    <div class="card-body">
      ...
      <form action="../scripts/register_user.php" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" autofocus placeholder="Podaj imię" name="firstname">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Podaj hasło" name="haslo1">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <select class="form-control" name="city_id">
                        ...
                        <?php
                          ...
                          while ($city = $result->fetch_assoc()){
                            ...
                            echo "<option value='$city_id'> $city[city] </option>";
